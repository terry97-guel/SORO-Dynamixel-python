import cv2
import numpy as np
from class_motionhelper import timer
import time
...
def run_snapbot(traj, snapbot, Hz, max_sec):
...
def run_snapbot_opticalflow(traj, snapbot, Hz, max_sec, cap):
