...
rospy.init_node("Macap")
vicon_marker = VICON()
number_of_data_to_collect = 100
...
count = 0
while len(depth_camera_pos_list)<number_of_data_to_collect:
...
# Data to be written
dictionary ={
    "depth_camera_pos_list": depth_camera_pos_list,
    "mocap_pos_list":mocap_pos_list
}  
# Serializing json 
json_object = json.dumps(dictionary)
  
# Writing to sample.json
with open("marker_pos_for_calibration.json", "w") as outfile:
